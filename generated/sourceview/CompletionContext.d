...
public class CompletionContext : ObjectG, ListModelIF
{
	 ...
	 * Since: 5.6
	 */
	public ListModelIF getProposalsForProvider(CompletionProviderIF provider)
	{
		auto __p = gtk_source_completion_context_get_proposals_for_provider(gtkSourceCompletionContext, (provider is null) ? null : provider.getCompletionProviderStruct());
	 ...
	 * Since: 5.6
	 */
	public ListModelIF listProviders()
	{
		auto __p = gtk_source_completion_context_list_providers(gtkSourceCompletionContext);
	 ...
	 * Since: 5.6
	 */
	gulong addOnProviderModelChanged(void delegate(CompletionProviderIF, ListModelIF, CompletionContext) dlg, ConnectFlags connectFlags=cast(ConnectFlags)0)
	{
		return Signals.connect(this, "provider-model-changed", dlg, connectFlags ^ ConnectFlags.SWAPPED);
	}
}
