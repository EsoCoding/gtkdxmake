...
public class Map : Widget
{
	 ...
	 *     latitude = the longitude to center the map at
	 *     longitude = the longitude to center the map at
	 *     zoomLevel = the zoom level to end at
	 */
	public void goToFull(double latitude, double longitude, double zoomLevel)
	{
		shumate_map_go_to_full(shumateMap, latitude, longitude, zoomLevel);
	}
	 ...
	 */
	public void goToFullWithDuration(double latitude, double longitude, double zoomLevel, uint durationMs)
	{
		shumate_map_go_to_full_with_duration(shumateMap, latitude, longitude, zoomLevel, durationMs);
	}
	...
	public void zoomIn()
	{
		shumate_map_zoom_in(shumateMap);
	}
	...
	public void zoomOut()
	{
		shumate_map_zoom_out(shumateMap);
	}
