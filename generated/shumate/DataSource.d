...
public class DataSource : ObjectG
{
	...
	{
		return shumate_data_source_get_max_zoom_level(shumateDataSource);
	}
	...
	{
		return shumate_data_source_get_min_zoom_level(shumateDataSource);
	}
	...
	{
		shumate_data_source_set_max_zoom_level(shumateDataSource, zoomLevel);
	}
	 ...
	 *
	 * Params:
	 *     zoomLevel = the minimum zoom level
	 */
	public void setMinZoomLevel(uint zoomLevel)
	{
		shumate_data_source_set_min_zoom_level(shumateDataSource, zoomLevel);
	}
