 ...
 * Since: 2.4
 */
public alias extern(C) void* function(void* src, void* userData) GCopyFunc;
 ...
 */
public alias extern(C) int function(GHook* hook, void* userData) GHookCheckMarshaller;
 ...
 * Params:
 *     hook = a #GHook
 *     userData = user data passed to g_hook_find_func()
 *
 * Returns: %TRUE if the required #GHook has been found
 */
public alias extern(C) int function(GHook* hook, void* userData) GHookFindFunc;
 ...
 *     userData = user data
 */
public alias extern(C) void function(GHook* hook, void* userData) GHookMarshaller;
 ...
 *     userData = user data set in g_io_add_watch() or g_io_add_watch_full()
 *
 * Returns: the function should return %FALSE if the event source
 *     should be removed
 */
public alias extern(C) int function(GIOChannel* source, GIOCondition condition, void* userData) GIOFunc;
 ...
 * Params:
 *     node = a #GNode.
 *     userData = user data passed to g_node_children_foreach().
 */
public alias extern(C) void function(GNode* node, void* userData) GNodeForeachFunc;
 ...
 * Params:
 *     node = a #GNode.
 *     userData = user data passed to g_node_traverse().
 *
 * Returns: %TRUE to stop the traversal.
 */
public alias extern(C) int function(GNode* node, void* userData) GNodeTraverseFunc;
 ...
 *     userData = User data added to the #GOptionGroup containing the option when
 ...
 */
public alias extern(C) int function(const(char)* optionName, const(char)* value, void* userData, GError** err) GOptionArgFunc;
 ...
 * Throws: GException on failure.
 */
public alias extern(C) void function(GOptionContext* context, GOptionGroup* group, void* userData, GError** err) GOptionErrorFunc;
 ...
 * Throws: GException on failure.
 */
public alias extern(C) int function(GOptionContext* context, GOptionGroup* group, void* userData, GError** err) GOptionParseFunc;
 ...
 */
public alias extern(C) int function(GSequenceIter* a, GSequenceIter* b, void* userData) GSequenceIterCompareFunc;
 ...
 *
 * Params:
 *     userData = data passed to the thread
 *
 * Returns: the return value of the thread
 */
public alias extern(C) void* function(void* userData) GThreadFunc;
 ...
 *     userData = user data specified when installing the function, e.g.
 *         in g_option_group_set_translate_func()
 *
 * Returns: a translation of the string for the current locale.
 *     The returned string is owned by GLib and must not be freed.
 */
public alias extern(C) const(char)* function(const(char)* str, void* userData) GTranslateFunc;
 ...
 *     value = the value corresponding to the key
 *     userData = user data passed to g_tree_traverse()
 *
 * Returns: %TRUE to stop the traversal
 */
public alias extern(C) int function(void* key, void* value, void* userData) GTraverseFunc;
 ...
 * Params:
 *     node = a #GTreeNode
 *     userData = user data passed to g_tree_foreach_node()
 *
 * Returns: %TRUE to stop the traversal
 *
 * Since: 2.68
 */
public alias extern(C) int function(GTreeNode* node, void* userData) GTraverseNodeFunc;
