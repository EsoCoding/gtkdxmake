...
public class Toast : ObjectG
{
	...
	{
		auto __p = adw_toast_get_custom_title(adwToast);
	...
	{
		adw_toast_set_custom_title(adwToast, (widget is null) ? null : widget.getWidgetStruct());
	}
	 ...
	 * Since: 1.2
	 */
	gulong addOnButtonClicked(void delegate(Toast) dlg, ConnectFlags connectFlags=cast(ConnectFlags)0)
	{
		return Signals.connect(this, "button-clicked", dlg, connectFlags ^ ConnectFlags.SWAPPED);
	}
