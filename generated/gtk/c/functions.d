...
__gshared extern(C)
{
	...
	GtkBookmarkList* gtk_bookmark_list_new(char* filename, const(char)* attributes);
	...
	int gtk_builder_add_from_file(GtkBuilder* builder, char* filename, GError** err);
	...
	int gtk_builder_add_objects_from_file(GtkBuilder* builder, char* filename, char** objectIds, GError** err);
	...
	void gtk_css_provider_load_from_path(GtkCssProvider* cssProvider, char* path);
	...
	int gtk_drop_down_get_show_arrow(GtkDropDown* self);
	...
	void gtk_drop_down_set_show_arrow(GtkDropDown* self, int showArrow);
	...
	GType gtk_inscription_get_type();
	GtkWidget* gtk_inscription_new(const(char)* text);
	PangoAttrList* gtk_inscription_get_attributes(GtkInscription* self);
	uint gtk_inscription_get_min_chars(GtkInscription* self);
	uint gtk_inscription_get_min_lines(GtkInscription* self);
	uint gtk_inscription_get_nat_chars(GtkInscription* self);
	uint gtk_inscription_get_nat_lines(GtkInscription* self);
	...
	void gtk_inscription_set_min_chars(GtkInscription* self, uint minChars);
	void gtk_inscription_set_min_lines(GtkInscription* self, uint minLines);
	void gtk_inscription_set_nat_chars(GtkInscription* self, uint natChars);
	void gtk_inscription_set_nat_lines(GtkInscription* self, uint natLines);
	...
	void gtk_inscription_set_wrap_mode(GtkInscription* self, PangoWrapMode wrapMode);
	...
	void gtk_label_set_natural_wrap_mode(GtkLabel* self, GtkNaturalWrapMode wrapMode);
	...
	void gtk_media_stream_stream_prepared(GtkMediaStream* self, int hasAudio, int hasVideo, int seekable, long duration);
	...
	int gtk_menu_button_get_always_show_arrow(GtkMenuButton* menuButton);
	GtkWidget* gtk_menu_button_get_child(GtkMenuButton* menuButton);
	...
	int gtk_menu_button_get_primary(GtkMenuButton* menuButton);
	...
	void gtk_menu_button_set_always_show_arrow(GtkMenuButton* menuButton, int alwaysShowArrow);
	void gtk_menu_button_set_child(GtkMenuButton* menuButton, GtkWidget* child);
	...
	void gtk_menu_button_set_primary(GtkMenuButton* menuButton, int primary);
	...
	void gtk_picture_set_content_fit(GtkPicture* self, GtkContentFit contentFit);
	...
	uint gtk_search_entry_get_search_delay(GtkSearchEntry* entry);
	void gtk_search_entry_set_key_capture_widget(GtkSearchEntry* entry, GtkWidget* widget);
	void gtk_search_entry_set_search_delay(GtkSearchEntry* entry, uint delay);
	...
	void gtk_symbolic_paintable_snapshot_symbolic(GtkSymbolicPaintable* paintable, GdkSnapshot* snapshot, double width, double height, GdkRGBA* colors, size_t nColors);
	...
	void gtk_text_compute_cursor_extents(GtkText* self, size_t position, graphene_rect_t* strong, graphene_rect_t* weak);
	...
	PangoContext* gtk_text_view_get_ltr_context(GtkTextView* textView);
	...
	PangoContext* gtk_text_view_get_rtl_context(GtkTextView* textView);
	...
	int gtk_tree_expander_get_indent_for_icon(GtkTreeExpander* self);
	...
	void gtk_tree_expander_set_indent_for_icon(GtkTreeExpander* self, int indentForIcon);
	...
	void gtk_widget_dispose_template(GtkWidget* widget, GType widgetType);
