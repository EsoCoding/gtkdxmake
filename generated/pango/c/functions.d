...
__gshared extern(C)
{
	...
	void pango_get_log_attrs(const(char)* text, int length, int level, PangoLanguage* language, PangoLogAttr* attrs, int attrsLen);
	...
	PangoFont* pango_font_deserialize(PangoContext* context, GBytes* bytes, GError** err);
	...
	void pango_glyph_string_index_to_x(PangoGlyphString* glyphs, const(char)* text, int length, PangoAnalysis* analysis, int index, int trailing, int* xPos);
	void pango_glyph_string_index_to_x_full(PangoGlyphString* glyphs, const(char)* text, int length, PangoAnalysis* analysis, PangoLogAttr* attrs, int index, int trailing, int* xPos);
	void pango_glyph_string_set_size(PangoGlyphString* string_, int newLen);
	void pango_glyph_string_x_to_index(PangoGlyphString* glyphs, const(char)* text, int length, PangoAnalysis* analysis, int xPos, int* index, int* trailing);
	...
	PangoLayout* pango_layout_deserialize(PangoContext* context, GBytes* bytes, PangoLayoutDeserializeFlags flags, GError** err);
	...
	void pango_layout_get_caret_pos(PangoLayout* layout, int index, PangoRectangle* strongPos, PangoRectangle* weakPos);
	...
	int pango_layout_get_justify_last_line(PangoLayout* layout);
	...
	void pango_layout_set_justify_last_line(PangoLayout* layout, int justify);
	...
	int pango_layout_write_to_file(PangoLayout* layout, PangoLayoutSerializeFlags flags, char* filename, GError** err);
	...
	int pango_layout_line_is_paragraph_start(PangoLayoutLine* line);
	...
	double pango_matrix_get_slant_ratio(PangoMatrix* matrix);
	...
	dchar pango_tab_array_get_decimal_point(PangoTabArray* tabArray, int tabIndex);
	...
	void pango_tab_array_set_decimal_point(PangoTabArray* tabArray, int tabIndex, dchar decimalPoint);
	void pango_tab_array_set_positions_in_pixels(PangoTabArray* tabArray, int positionsInPixels);
	void pango_tab_array_set_tab(PangoTabArray* tabArray, int tabIndex, PangoTabAlign alignment, int location);
	void pango_tab_array_sort(PangoTabArray* tabArray);
	char* pango_tab_array_to_string(PangoTabArray* tabArray);
